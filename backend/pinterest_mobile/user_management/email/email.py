...
def send_otp_to_email(email, message):
    try:
        ...
        subject = f"Pinterest Clone OTP for Account Verification"
        otp_message = f"""
        <!DOCTYPE html>
        <html lang=\"en\">
            <head>
    ...
    <div style=\"max-width: 680px; margin: 0 auto; padding: 45px 30px 60px; background: #f4f7ff; background-image: url(https://archisketch-resources.s3.ap-northeast-2.amazonaws.com/vrstyler/1661497957196_595865/email-template-background-banner); background-repeat: no-repeat; background-size: 800px 452px; background-position: top center; font-size: 14px; color: #434343;\">
        ...
        <div style=\"margin: 0; margin-top: 70px; padding: 92px 30px 115px; background: #ffffff; border-radius: 30px; text-align: center;\">
            ...
            <p style=\"margin: 0; margin-top: 17px; font-weight: 500; letter-spacing: 0.56px;\">
                Thank you for choosing Pinterest Clone. Use the following OTP to complete the procedure to change your email address. OTP is valid for 
...
def send_reset_password(email):
    try:
        otp = random.randint(100000, 999999)
        subject = f"Pinterest Clone Reset Password"
        message = f"""
        <!DOCTYPE html>
        <html lang=\"en\">
            <head>
    ...
    <div style=\"max-width: 680px; margin: 0 auto; padding: 45px 30px 60px; background: #f4f7ff; background-image: url(https://archisketch-resources.s3.ap-northeast-2.amazonaws.com/vrstyler/1661497957196_595865/email-template-background-banner); background-repeat: no-repeat; background-size: 800px 452px; background-position: top center; font-size: 14px; color: #434343;\">
        ...
        <div style=\"margin: 0; margin-top: 70px; padding: 92px 30px 115px; background: #ffffff; border-radius: 30px; text-align: center;\">
            ...
            <p style=\"margin: 0; margin-top: 17px; font-size: 16px; font-weight: 500;\">Hey {email},</p>
            <p style=\"margin: 0; margin-top: 17px; font-weight: 500; letter-spacing: 0.56px;\">
                Thank you for choosing Pinterest Clone. Use the following Reset Password OTP to complete the procedure to reset your password. The Reset Password OTP is valid for 
                <span style=\"font-weight: 600; color: #1f1f1f;\">2 minutes</span>. Do not share this code with others.
            </p>
            <p style=\"margin: 0; margin-top: 60px; font-size: 40px; font-weight: 600; letter-spacing: 25px; color: #ba3d4f;\">{otp}</p>
            </div>
